...
$8400) is zero-padded up to $8400 and the 19 200-byte packed art blob
...
relocated and its absolute art pointers ($8400) would read garbage.
...
def build_game_prg(work):
    """--detail build, tokenised, zero-padded to $A700, RLE art appended.
